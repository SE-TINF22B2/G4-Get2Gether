...
public class TestController {
    ...
    public ResponseEntity<Token> authenticateUser(@RequestBody Token token, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (authentication != null) {
            ...
            createSession(authentication, request, response);
...
//            return new ResponseEntity<>(HttpStatus.UNAUTHORIZED);
    ...
    public void createSession(Authentication authentication, HttpServletRequest request, HttpServletResponse response){
...
//
    ...
    @GetMapping("/any")
    public ResponseEntity<Token> any( HttpServletRequest request, HttpServletResponse response) {
